...
const CoinItem = ({ marketCoin }) => {
  ...
  const persentageColor = price_change_percentage_24h < 0 ? "#ea3943" : "#16c784" || "white";
    ...
    <Pressable style={styles.coinContainer} onPress={() => navigation.navigate("CoinDetailedScreen", { coinId: id })}>
      ...
      <View>
        ...
        <View style={{ flexDirection: "row" }}>
          ...
          <AntDesign name={price_change_percentage_24h < 0 ? "caretdown" : "caretup"} size={12} color={persentageColor} style={{ alignSelf: "center", marginRight: 5 }} />
          <Text style={{ color: persentageColor }}>{price_change_percentage_24h?.toFixed(2)}%</Text>
        </View>
      </View>
