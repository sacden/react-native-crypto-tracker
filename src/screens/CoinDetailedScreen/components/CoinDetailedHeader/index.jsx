...
const CoinDetailedHeader = (props) => {
  ...
  const checkIfCoinIsWatchlisted = () =>
    watchlistCoinIds.some((coinIdValue) => {
  ...
  return (
    <View style={styles.headerContainer}>
      ...
      <FontAwesome name={checkIfCoinIsWatchlisted() ? "star" : "star-o"} size={25} color={checkIfCoinIsWatchlisted() ? "#FFBF00" : "white"} onPress={handleWatchlistCoin} />
    </View>
  );
};
